...
const TRAIN_DATASET_PATH = path.join(__dirname, "./data/ampds_power_30T_iso.csv");
const PREDICTIONS_STATES_PATH = path.join(__dirname, "./data/ampds_power_30T_states_iso.csv");
